class IngredientsController < ApplicationController
  def index
    ...
    @ingredients = @q.result(:distinct => true).includes(:ingredient_ascs, :aisle).page(params[:page]).per(10)
  ...
  def create
    ...
    @ingredient.aisle_id = params[:aisle_id]
    @ingredient.list = params[:list]
